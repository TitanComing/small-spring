...
import peng.springframework.aop.framework.adapter.MethodBeforeAdviceInterceptor;
...
public class Middle7ApiTest {
    ...
    public void test_advisor() {
        ...
        advisor.setExpression("execution(* peng.springframework.aop.IUserService.*(..))");
    ...
    public void test_aop() {
        ClassPathXmlApplicationContext applicationContext = new ClassPathXmlApplicationContext("classpath:springAOP2.xml");
